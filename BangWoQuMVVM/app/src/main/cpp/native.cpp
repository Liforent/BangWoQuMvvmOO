...
Java_com_zues_ruiyu_bangwoqu_ocr_OCRPredictorNative_init(
...
Java_com_zues_ruiyu_bangwoqu_ocr_OCRPredictorNative_forward(
...
Java_com_zues_ruiyu_bangwoqu_ocr_OCRPredictorNative_release(
