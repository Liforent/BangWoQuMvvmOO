 ...
 */
public class ZssCountDownTextView extends TextView implements LifecycleObserver, View.OnClickListener {
    ...
    public ZssCountDownTextView(Context context) {
        this(context, null);
    }

    public ZssCountDownTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZssCountDownTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @param normalText 文本
     */
    public ZssCountDownTextView setNormalText(String normalText) {
     ...
     */
    public ZssCountDownTextView setCountDownText(String front, String latter) {
     ...
     * @param intervalUnit
     */
    public ZssCountDownTextView setIntervalUnit(TimeUnit intervalUnit) {
    ...
    public ZssCountDownTextView setOnCountDownStartListener(OnCountDownStartListener onCountDownStartListener) {
        mOnCountDownStartListener = onCountDownStartListener;
        return this;
    }

    public ZssCountDownTextView setOnCountDownTickListener(OnCountDownTickListener onCountDownTickListener) {
        mOnCountDownTickListener = onCountDownTickListener;
        return this;
    }

    public ZssCountDownTextView setOnCountDownFinishListener(OnCountDownFinishListener onCountDownFinishListener) {
     ...
     */
    public ZssCountDownTextView setCountDownClickable(boolean clickable) {
     ...
     * @param keep 是否保持
     */
    public ZssCountDownTextView setCloseKeepCountDown(boolean keep) {
     ...
     */
    public ZssCountDownTextView setShowFormatTime(boolean formatTime) {
